...
public class RecyclerViewDaftarMhs extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.menu1){
            Intent intent = new Intent(RecyclerViewDaftarMhs.this,CreateMhs.class);
    ...
    private void tambahData(){
        ...
        mhsList.add(new Mahasiswa("72170177","Daniel","daniel.surya@si.ukdw.ac.id","Jl.Wates",R.drawable.logo));
        mhsList.add(new Mahasiswa("72170177","Daniel","daniel.surya@si.ukdw.ac.id","Jl.Wates",R.drawable.logo));
        mhsList.add(new Mahasiswa("72170177","Daniel","daniel.surya@si.ukdw.ac.id","Jl.Wates",R.drawable.logo));
    }
}
